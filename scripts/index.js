...
// Set font for the additional text
ctx.font = '20px Verdana';
ctx.fillStyle = 'white'; // Set the fill color to white

// Position the text at the bottom center of the canvas
const text = 'Yours Truly, Besa';
const textWidth = ctx.measureText(text).width;
const textX = (w - textWidth) / 2;
const textY = h - 20; // Adjust the vertical position as needed

// Draw a background rectangle
const padding = 5; // Add some padding around the text
ctx.fillRect(textX - padding, textY - 20 - padding, textWidth + 2 * padding, 30);

// Draw the text
ctx.fillStyle = '#333'; // Set the text color to your preference
